...
public class Fighter : ScriptableObject
{
    ...
    public enum TimeBuff{None,Quicken,Delay,Stop};
    ...
    [SerializeField]protected int _buffCycles, _cyclesNeeded = 0;
    protected TimeBuff _activeTimeBuff = TimeBuff.None;
    ...
    protected float _actionValue = 999f;

    protected float _focus = 0f;
    ...
    public void AdjustStatByLevelUp()
    {
    ...
    public void DupeFighter(Fighter mainPlayer)
    {
